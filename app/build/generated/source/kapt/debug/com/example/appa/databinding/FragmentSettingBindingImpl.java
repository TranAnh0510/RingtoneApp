...
public class FragmentSettingBindingImpl extends FragmentSettingBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvLanguageOptions, 2);
        sViewsWithIds.put(R.id.tvRateUs, 3);
        sViewsWithIds.put(R.id.tvPrivacyPolicy, 4);
        sViewsWithIds.put(R.id.tvShareApp, 5);
    }
    // views
    @NonNull
