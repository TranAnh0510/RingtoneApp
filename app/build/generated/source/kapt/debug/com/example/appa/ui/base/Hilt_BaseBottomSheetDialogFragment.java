 ...
 */
public abstract class Hilt_BaseBottomSheetDialogFragment extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BaseBottomSheetDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BaseBottomSheetDialogFragment_GeneratedInjector) this.generatedComponent()).injectBaseBottomSheetDialogFragment(UnsafeCasts.<BaseBottomSheetDialogFragment>unsafeCast(this));
    }
  }
