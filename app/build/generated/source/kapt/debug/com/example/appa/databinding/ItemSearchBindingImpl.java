...
public class ItemSearchBindingImpl extends ItemSearchBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.imSound, 3);
        sViewsWithIds.put(R.id.imPlay, 4);
        sViewsWithIds.put(R.id.tvNameSound, 5);
        sViewsWithIds.put(R.id.tvDuration, 6);
        sViewsWithIds.put(R.id.imMore, 7);
        sViewsWithIds.put(R.id.imMoreInvisible, 8);
        sViewsWithIds.put(R.id.imDownload, 9);
    }
    // views
    @NonNull
