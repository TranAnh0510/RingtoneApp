...
public final class RecentVM_Factory implements Factory<RecentVM> {
  ...
  public RecentVM_Factory(Provider<MusicServerRepo> musicServerRepoProvider,
  ...
  public static RecentVM_Factory create(Provider<MusicServerRepo> musicServerRepoProvider,
      Provider<RecentRepo> recentRepoProvider, Provider<FavoriteRepo> favoriteRepoProvider) {
    return new RecentVM_Factory(musicServerRepoProvider, recentRepoProvider, favoriteRepoProvider);
  }

  public static RecentVM newInstance(MusicServerRepo musicServerRepo, RecentRepo recentRepo,
      FavoriteRepo favoriteRepo) {
    return new RecentVM(musicServerRepo, recentRepo, favoriteRepo);
  }
}
