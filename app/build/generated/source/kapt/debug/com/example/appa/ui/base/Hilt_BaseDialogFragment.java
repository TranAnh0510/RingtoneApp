 ...
 */
public abstract class Hilt_BaseDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BaseDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BaseDialogFragment_GeneratedInjector) this.generatedComponent()).injectBaseDialogFragment(UnsafeCasts.<BaseDialogFragment>unsafeCast(this));
    }
  }
