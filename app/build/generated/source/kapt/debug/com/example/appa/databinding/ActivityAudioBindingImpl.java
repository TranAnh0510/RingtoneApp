...
public class ActivityAudioBindingImpl extends ActivityAudioBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.imChooseAudio, 2);
        sViewsWithIds.put(R.id.tvTitle, 3);
        sViewsWithIds.put(R.id.tvAllAudio, 4);
        ...
        sViewsWithIds.put(R.id.rcAudioGrid, 10);
        sViewsWithIds.put(R.id.rcAudio, 11);
    ...
    public ActivityAudioBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 16, sIncludes, sViewsWithIds));
    }
    private ActivityAudioBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
