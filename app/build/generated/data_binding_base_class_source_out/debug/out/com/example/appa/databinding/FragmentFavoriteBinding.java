...
public abstract class FragmentFavoriteBinding extends ViewDataBinding {
  ...
  @NonNull
  public final RecyclerView rcMyFavorites;
  ...
  protected FragmentFavoriteBinding(Object _bindingComponent, View _root, int _localFieldCount,
      ImageView imNoData, RecyclerView rcMyFavorites, TextView tvContentNoData, TextView tvTitle,
      TextView tvTitleNoData) {
    super(_bindingComponent, _root, _localFieldCount);
    this.imNoData = imNoData;
    this.rcMyFavorites = rcMyFavorites;
