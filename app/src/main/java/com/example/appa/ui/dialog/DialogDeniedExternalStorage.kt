...
import com.example.appa.databinding.DialogDeniedExternalStorageBinding
import com.example.appa.ui.base.BaseBindingDialogFragment
import com.example.appa.util.extension.setOnSafeClick

class DialogDeniedExternalStorage :
    BaseBindingDialogFragment<DialogDeniedExternalStorageBinding>() {

    var onClickGotoSetting: (() -> Unit) = {}
    override val layoutId: Int
        get() = R.layout.dialog_denied_external_storage
