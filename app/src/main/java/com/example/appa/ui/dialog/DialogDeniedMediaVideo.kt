...
import com.example.appa.databinding.DialogDeniedMediaVideoBinding
import com.example.appa.ui.base.BaseBindingDialogFragment
import com.example.appa.util.extension.setOnSafeClick



class DialogDeniedMediaVideo : BaseBindingDialogFragment<DialogDeniedMediaVideoBinding>() {

    var onClickGotoSetting: (() -> Unit) = {}
    override val layoutId: Int
        get() = R.layout.dialog_denied_media_video
